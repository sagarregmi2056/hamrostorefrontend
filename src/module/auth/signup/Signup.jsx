          ...
          <div className="relative">
            <div className="w-full max-w-xl xl:mx-auto xl:w-full xl:max-w-xl xl:pr-24">
              <h3 className="text-4xl font-bold text-white">
                Wanna dive into the world of online shopping for the quality product?
              </h3>
              <ul className="mt-10 grid grid-cols-1 gap-x-8 gap-y-4 sm:grid-cols-2">
                ...
                <li className="flex items-center space-x-3">
                  ...
                  <span className="text-lg font-medium text-white"> 120+ partnerships </span>
                </li>
                <li className="flex items-center space-x-3">
                  <div className="inline-flex h-5 w-5 flex-shrink-0 items-center justify-center rounded-full bg-blue-500">
                    <svg
                  ...
                  <span className="text-lg font-medium text-white"> Quality product </span>
                </li>
              </ul>
            </div>
          </div>
